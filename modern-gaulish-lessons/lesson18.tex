\section{Menghavan 18: Rithi\'{u}nan In Gwep}
...
\centering
    ...
    \cellcolor{lightgreen}\textcolor{darkgreen}{\textbf{R\'{\i}an}} & \cellcolor{lightgreen} & \cellcolor{lightgreen}\textcolor{darkgreen}{\textbf{Cingeth}}\\
    \cellcolor{lightgreen} & \cellcolor{lightgreen} & \cellcolor{lightgreen}\\
    \cellcolor{lightgreen} & \cellcolor{lightgreen} & \cellcolor{lightgreen}\\
    \cellcolor{lightgreen} & \cellcolor{lightgreen} & \cellcolor{lightgreen}\\
    \cellcolor{lightgreen} & \cellcolor{lightgreen} & \cellcolor{lightgreen}\\
...
%TODO: create table with rows:
% english 2 sentences
% row below it with B: and G: and an empty field next to it.
...
%TODO: Make a nice solution table.
