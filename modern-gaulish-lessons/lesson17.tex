...
\rotatebox{180}{%
  ...
  \toprule
  The first house is bigger than the second house.\\
  \textit{Esi in t\'{e}i cin gwer w\'{a}r co'n t\'{e}i c\'{\i}al.}\\
  \midrule
  The third horse is as fast as the fourth horse.\\
  \textit{Esi in \'{e}p tr\'{\i}thu co h\'{a}chu co in \'{e}p peth\'{u}ar.}\\
  \midrule
  The fifth mountain is the highest one.\\
  \textit{Esi in vr\'{\i} pimpeth hardh\'{u}am.}\\
  \midrule
  The seven little pigs have eaten fourteen haystacks.\\
  \textit{Depr\'{\i}thu in s\'{e}ith mochal pethrdhech bargh.}\\
  \midrule
  The twenty-three little dolphins jumped out of the water.\\
  \textit{R\'{e} shuling in gwochon-tr\'{\i} m\'{o}rchunal e in duvr.}\\
  \midrule
  There are thirty-one little whales dead on the beach.\\
  \textit{Esi gwochon-onech caur'w\'{o}ral marus gwer in dr\'{a}ith.}\\
  \midrule
  The forty-eighth warrior was fighting naked. [*attention: naked is here used as an adverb]\\
  \textit{B\'{u} in dachwochon-\'{o}ithweth cingeth en vathi in dherthol.}\\
  \midrule
  There were seventy-five druids in the sacred forest.\\
  \textit{B\'{u} trichwochon-pimdhech dr\'{u}idh en in c\'{e}th n\'{o}iv.}\\
  \midrule
  On the eighty-nineth day after the summer solstice the little white bull was sacrificed.\\
  \textit{A'n dh\'{\i} pethrchwochon-nameth \'{o}s in sh\'{a}n's\'{u}el sam b\'{u} averthw\'{\i}thu in tar\'{u}al gwin.}\\
  \bottomrule
  \end{tabular}
}
\label{solution_comparison_diminutive_numbers}
\caption{Solution: comparison, diminutive and numbers}
\end{table}
