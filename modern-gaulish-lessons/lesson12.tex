...
\begin{tabu}{rccl}
  \multirow{2}{*}{
    \begin{subfigure}{0.3\textwidth}
      \includegraphics[height=5.0cm]{img/menghavan12_1}
      \caption{Tarchonwoth}
    \end{subfigure}
  } & \multicolumn{1}{l}{D\'{\i} wath, p\'{e} gaman a hesi ti?} & & \multirow{2}{*}{
    \begin{subfigure}{0.3\textwidth}
      \includegraphics[height=5.0cm]{img/menghavan12_2}
      \caption{Tuthch\'{a}na}
    \end{subfigure}
    }\\
    & & \multicolumn{1}{r}{\textit{D\'{i} wath adhith c\'{o}\'{e}th. Esi mi in dh\'{a}i, br\'{a}thu. Ach ti-s\'{u}\'{e}?}} & \\
\end{tabu}
