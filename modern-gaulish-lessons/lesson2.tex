...
Only the third person plural pronoun differs: \textit{\'{\i}s} instead of \textit{s\'{\i}}.\\
...
V & S & O
\end{tabular}
\caption{Example: verbs vso indication}
\label{example_verbs_vso_indication}
\end{table}
...
\begin{tabular}{cc}
  ...
  \bottomrule
\end{tabular}
\caption{Personal pronoun, particle \textit{i-}}
