...
\subsection{Gwepchoprith: The article}
\subsubsection{The article}

Modern Gaulish has one article: \textit{in}. It does not change for any reason.\\
...
\begin{tabular}{cc}
  ...
  \bottomrule
\end{tabular}
\caption{Example: the article in}
\label{example_article_in}
\end{table}
...
\caption{Solution: the article in}
\end{table}
