...
%    \begin{tabu}{cM{7.0cm}c}
%    \textcolor{darkgreen}{\textbf{Tarchonwoth}} & & \textcolor{darkgreen}{\textbf{Tuthch\'{a}na}} \\
%    \multirow{8}{*}{\includegraphics[height=4.0cm]{img/menghavan12_1}} & \multicolumn{1}{l}{D\'{\i} wath, p\'{e} gaman a hesi ti?} & \multirow{8}{*}{\includegraphics[height=4.0cm]{img/menghavan12_2}} \\
%    & \multicolumn{1}{r}{\textit{D\'{\i} wath adhith c\'{o}\'{e}th.}} & \\
%    & \multicolumn{1}{r}{\textit{Esi mi in dh\'{a}i, br\'{a}thu.}} & \\
%    & \multicolumn{1}{r}{\textit{Ach ti-s\'{u}\'{e}?}} & \\
%    & \multicolumn{1}{l}{Esi mi in dh\'{a}i c\'{o}\'{e}th.} & \\
%    & \multicolumn{1}{r}{\textit{Gwerthamich.}} & \\
%    & \multicolumn{1}{l}{Gw\'{e}la mi prin \'{e}p.} & \\
%    & \multicolumn{1}{l}{A ghn\'{\i}a ti don nep o g\'{a}la \'{e} rin\'{o}thi \'{e}p adhim?} & \\
%    & \multicolumn{1}{r}{\textit{Gn\'{\i}a mi.}} & \\
%    & \multicolumn{1}{r}{\textit{Gn\'{\i}a mi ben shen o g\'{a}la \'{o} d\'{u}ithir rin\'{o}thi \'{e}p adhith.}} & \\
%    & \multicolumn{1}{r}{\textit{Esi \'{o} anu Cunv\'{a}ra.}} & \\
%    & \multicolumn{1}{r}{\textit{\'{A}i a gantha hal in bron ach p\'{e}tha adh\'{\i} ins\'{e}.}} & \\
%    & \multicolumn{1}{l}{Br\'{a}thu r\'{e} h\'{e}lu, esi ti r\'{e} chw\'{o}rethw\'{a}r.} & \\
%    & \multicolumn{1}{r}{\textit{Esi \'{\i} m\'{o} har\'{u}er im\'{\i}. Esi \'{\i} neveth.}} & \\
%    & & \\
%    & \multicolumn{1}{c}{$\dagger$ $\dagger$ $\dagger$} & \\
%    & & \\
%    \multicolumn{3}{c}{\textcolor{darkgray}{\textit{\'{A}ia Tarchonwoth a h\'{a}pis in ven shen a gantha hal in bron.}}}\\
%    & & \\
%    & \multicolumn{1}{c}{$\dagger$ $\dagger$ $\dagger$} & \\
%    & & \\
%    \textcolor{darkgreen}{\textbf{Tarchonwoth}} & & \textcolor{darkgreen}{\textbf{Cunv\'{a}ra}} \\
%    \multirow{2}{*}{\includegraphics[height=2.0cm]{img/menghavan12_3}} & \multicolumn{1}{l}{D\'{\i} wath. A hesi \'{\i} ti-s\'{u}\'{e} o t\'{o} dh\'{u}ithir \'{\i}-esi \'{e}p a brin?} & \multirow{2}{*}{\includegraphics[height=2.0cm]{img/menghavan12_4}} \\
%    & \multicolumn{1}{r}{\textit{Esi \'{\i} mi-s\'{u}\'{e}.}} & \\
%    & \multicolumn{1}{r}{\textit{A chw\'{e}la ti \'{a}pis in \'{e}p o g\'{a}la m\'{o} dh\'{u}ithir rin\'{o}thi ich\'{\i}?}} & \\
%    & \multicolumn{1}{r}{} & \\
%    & & \\
%    & & \\
%    & & \\
