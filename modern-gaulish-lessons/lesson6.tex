...
\subsection{Gwepchoprith: Feminine nouns and the article}
...
\begin{tabular}{cccc}
  ...
  \bottomrule
\end{tabular}
\caption{Example: article, feminine nouns}
\label{example_article_feminine_nouns}
\end{table}

The semi-vowel \textit{i-} (/y/ in English, $[$j$]$) is prefixed with a \textit{ch'}:
\begin{table}[H]
\centering
\begin{tabular}{cccc}
  \toprule
  ...
  \bottomrule
\end{tabular}
\caption{Example: article, semi vowel \textit{i}}
\label{example_article_semi_vowel_i}
\end{table}
...
\begin{tabular}{cccc}
  ...
  \bottomrule
\end{tabular}
\caption{Example: article, prefix \textit{h}}
\label{example_article_prefix_h}
\end{table}
...
\begin{tabular}{cc}
  ...
  \bottomrule
\end{tabular}
\caption{Example: fix \textit{h}}
\label{example_fix_h}
\end{table}

\subsubsection{Initial consonant mutation changes}
...
\newpage
\subsection{Exercises: Initial consonant mutation changes}

\subsubsection{Put the article in front of the words}
